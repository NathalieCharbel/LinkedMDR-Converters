			...
			<div class="container-fluid content-middle">
				<div class="row row-middle">
					<form action="SrvMain" method="post" enctype="multipart/form-data">
						...
						<div class="col-md-offset-1 col-xs-11 col-sm-11 col-md-11  col-standards">
						
							<!-- Include fragment upload.jsp to the main page -->
							<jsp:include page="standards_form.jsp" />
							
						</div>
						
						<div class="col-md-offset-1 col-xs-11 col-sm-11 col-md-11 col-linkedmdr">
						
							<!-- Include fragment upload.jsp to the main page -->
							<jsp:include page="linkedmdr_form.jsp" />
						</div>
					</form>
				</div>
			</div>
