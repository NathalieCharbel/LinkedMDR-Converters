...
import com.prototype.dc.DublinCore;
import com.prototype.linkedmdr.LinkedMdr;
import com.prototype.mpeg7.Mpeg7_Vd;
import com.prototype.tei.Tei;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // LinkedMDR
     	if (fileLinked.getLinkedmdr()!=null && fileLinked.getLinkedmdr()==true){
			...
			try {
				linkedmdr.doLinkedMDR(request,response,fileLinked.getFilePath(), fileLinked.getFileName());
			} catch (TransformerConfigurationException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
