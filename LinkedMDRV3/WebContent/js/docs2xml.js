$(document).ready(function() {
	...
	/**Add-button / add row**/
	var row=0;
	$(document).on('click', ".add-file-2xml", function() {         
   	    ...
   	    var $row = $('<tr>'+
	    	  ...
	    	  //td name
	           ...
	           "</td>"+
		          //td actions
	    	   '<td>' +
				'<label for="download"><button id="download-button-xml" class="btn btn-primary btn-sm btn-download" disabled> Download</button> </label> <input style="display: none;" class="input-dl" name="download-button" value='+row+'></input>' + 
   ...
   //Function check multiple-linkedmdr and enabled/disabled button linkedmdr
	...
	/** Modify the "tips" when user click "document to xmlf" **/
